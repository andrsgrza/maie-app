...
const RegistryForm = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try{
      const response = await LoginClient.requestSignUp(formData.username, formData.password, formData.email, formData.telephone);
      addBanner(
      ...
      addBanner('error', 'Somethig went wrong', 'Something went wrong while calling registration service.');
    }
  };
